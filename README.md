...
- Click a star to fly in. The Hub is live. Trading, Photography, and Poker are interiors — click the star again (or Enter world) to dive in.
- Photography’s star is a 3D camera. Poker’s star is two stacked chips with Ace–King of spades glued as one craft. Leave world returns to that focused star.
...
- Share a star with a hash, e.g. `/#hub`, `/#trading`, `/#world/photography`, `/#world/poker`, `/#gallery`, `/#backtest`.
